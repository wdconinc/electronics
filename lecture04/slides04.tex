...
\titlegraphic{\pgfimage[height=0.5\textheight]{pics/brita}}
...
\begin{frame}[t]
 ...
 \begin{block}{Example: Square wave}
  \begin{center}
   \pgfimage[width=0.5\textwidth]{pics/square_wave}
  \end{center}
...
\begin{frame}[t]
 ...
 \begin{block}{Example: Square wave}
  \begin{center}
   \pgfimage[width=0.48\textwidth]{pics/square_wave_approximation}
  \end{center}
...
\only<1>{
 ...
 \begin{block}<2>{Example: Square wave and triangle wave}
  \begin{center}
   \pgfimage[width=0.65\textwidth]{pics/square_wave_b_n}
  \end{center}
 \end{block}
\end{frame}
...
\frametitle{Fourier transform}
\begin{center}
\pgfimage[height=0.7\textheight]{pics/fourier} \\
